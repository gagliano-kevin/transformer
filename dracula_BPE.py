...
tokenizer_files_exist = os.path.exists("dracula_tokenizer-vocab.json") and os.path.exists("dracula_tokenizer-merges.txt")
...
bpe_tokenizer = ByteLevelBPETokenizer(
    "dracula_tokenizer-vocab.json",
    "dracula_tokenizer-merges.txt"
)
