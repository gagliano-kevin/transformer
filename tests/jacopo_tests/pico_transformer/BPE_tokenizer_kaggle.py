...
class CustomBPETokenizer:
    ...
    def load_model(self):
        ...
        # Construct file paths
        vocab_file = f"/kaggle/input/bpe-tokenizer/tokenizer_vocab.json"
        merges_file =  f"/kaggle/input/bpe-tokenizer/tokenizer_merges.txt"
                    ...
                    if len(merge_tokens) == 2:
                        ...
                        try:
                            ...
                            if id1 is not None and id2 is not None:
                                ...
                                if self.log: print(f"Warning: Could not find token IDs for merge: '{s1_rendered}', '{s2_rendered}' in the loaded vocabulary.")
                        except ValueError:
