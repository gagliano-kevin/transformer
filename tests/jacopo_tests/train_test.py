...
if __name__ == "__main__":
    ...
    tokenizer = simple_init_tokenizer(vocab_size=6000, pretrained=False, log=True)
    ...
    with open('bpe_6k_no_monte_cristo_encoded_text.txt', 'w') as f:
    ...
    train_model(
        ...
        num_epochs=1,
        log_freq=100,
        model_name="no_monte_cristo_6k_transformer",
