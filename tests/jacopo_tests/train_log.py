...
def load_data_from_files(file_paths=["dracula-stoker.txt", "Psychology-and-Pedagogy-of-Anger.txt", "The-Invisible-Man.txt", "The-Killing-Complex.txt", "20000_leagues_under_the_sea.txt"]):
    """
